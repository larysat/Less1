...
export function map(mapper: () => string, input: Array<number>): Array<string> | Function {
 ...
 * @return {Array | Function}
 */
export function filter(filterer: () => number, input: Array<number>): Array<number> | Function {
  if (arguments.length === 0) {
    return filter;
  }
  if (arguments.length === 1) {
    return function subFunction(subInput: Array<number>) {
      if (arguments.length === 0) {
        return subFunction;
      }
